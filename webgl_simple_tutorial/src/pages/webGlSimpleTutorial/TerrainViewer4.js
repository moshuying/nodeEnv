  ...
  render() {
    return (
      <div className="upload">
        <input type='file' id='demFile4'></input>
        <canvas id="TerrainViewer4"></canvas>
      <div className="summary" >通过包围球来设置模型视图投影变换，显示合适的渲染位置。</div>
      </div>
    )
  }
}
...
async function main() {
  var demFile = document.getElementById('demFile4');
  if (!demFile) {
  ...
  // 获取 <canvas> 元素
  var canvas = document.getElementById('TerrainViewer4');
