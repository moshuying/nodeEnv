...
export default class HelloPoint1 extends React.Component{
  ...
  render() {
    return (
      ...
      <div className="summary" >综合WebGL的知识，实现了绘制一张地形图的实例。</div>
      </div>
    )
  }
}
...
async function main() {
  ...
  //加载文件后的事件
  demFile.addEventListener("change", redFile);

  // 获取 <canvas> 元素
  var canvas = document.getElementById('TerrainViewer');
